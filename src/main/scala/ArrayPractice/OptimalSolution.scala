...
/*
  This is the problem mentioned in https://practice.geeksforgeeks.org/problems/the-optimal-selection/0#ExpectOP
...
object OptimalSolution extends App{
  val testCase = 1
  val arrlen = 5
  val arr = Array(1,2,2,4,9)
  val lastvalue = ArrayBuffer[Int]()
  var totalpoints =0
  calculate
  def calculate={
    for(a <- arr){
